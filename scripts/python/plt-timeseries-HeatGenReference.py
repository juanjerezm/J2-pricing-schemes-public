...
width_cm = 15
height_cm = 10  # Increased to accommodate two plots
...
file_path = f'M:/J2/results/selected_weeks/{CASE}/csv/GENERATION_HEAT.csv'
secoond_path = r'm:\J2\results\selected_weeks\C2\MCH.csv'
output_path = f'M:/J2/results/selected_weeks/consolidated/figures/HeatGenerationReference.png'
...
# Create subplots
fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(width_cm / 2.54, height_cm / 2.54), sharex=True)
...
data_MCH.plot(kind='line', ax=ax2, linewidth=1.5, legend=False, color='black')
...
# save the plot
plt.savefig(output_path, dpi=DPI_PRINT, bbox_inches='tight')
# plt.show()
